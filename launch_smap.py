...
dir_in=os.path.realpath(config.get('DIR','input_dir'))
files_in=glob.glob(dir_in+"/*/measurement_l1a.nc")

n_file_to_process=len(files_in)
list_bash_cmd_filename=[]

for filename_l1a in files_in:
